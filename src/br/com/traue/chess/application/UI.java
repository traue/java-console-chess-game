...
public class UI {
	...
	public static void printMatch(ChessMatch chessMatch, List<ChessPiece> captured) {
		...
		if (!chessMatch.getCheckMate()) {
			...
			System.out.println(chessMatch.getCurrentPlayer() + "WINS! :D");
		}
	}
	...
	private static void printCapturedPieces(List<ChessPiece> captured) {
		List<ChessPiece> white = captured.stream().filter(w -> w.getColor() == Color.WHITE)
				.collect(Collectors.toList());
		List<ChessPiece> black = captured.stream().filter(b -> b.getColor() == Color.BLACK)
				.collect(Collectors.toList());
